...
- Использовать селекторы с потоками для параллелизма
- Мультрипроцессы попробовать
- два main (один с тредами) (другой мультипроцессны main с теме же тредами) (еще один с asyncIo)
- Попробовать с конфигом на меньшее кол-во  
