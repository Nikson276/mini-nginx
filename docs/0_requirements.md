...
Доп:
- [ ] Добавить какой-то trace_id для прослеживаемости одного запроса через все этапы проксирования в логах.
- [ ] Метрики (кол-во запросов, ответов, ошибок) (отдельный сервис, который это все аккумулировать, и по ручке отдавать отчет)
- [ ] 
